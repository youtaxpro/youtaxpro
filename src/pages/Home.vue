    ...
    <nav :class="{ 'nav-scrolled': isScrolled }">
      ...
      <div class="nav-content" :class="{ 'show': isMenuOpen }">
        <ul class="nav-links" :class="{ 'active': isMenuOpen }">
          <li><a href="#" @click.prevent="scrollTo('aboutus')">{{ $t('nav.aboutUs') }}</a></li>
          <li><a href="#" @click.prevent="scrollTo('services')">{{ $t('nav.services') }}</a></li>
          <li><a href="#" @click.prevent="scrollTo('checklists')">{{ $t('nav.checklists') }}</a></li>
