...
const baseRoutes = [
  ...
  { seg: 'guides', name: 'GuidesIndex', component: () => import('../pages/GuidesIndex.vue') },
  { seg: 'feie', name: 'FeieLanding', component: Landing },
  { seg: 'exit-tax', name: 'ExitTaxLanding', component: Landing },
  { seg: 'pfic', name: 'PficLanding', component: Landing },
  { seg: 'itin', name: 'ItinLanding', component: Landing },
